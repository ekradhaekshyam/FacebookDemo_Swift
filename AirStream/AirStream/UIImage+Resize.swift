...
extension UIImage {
    ...
    func resizedImage(
        ...
        interpolationQuality quality:CGInterpolationQuality
            ...
            var bitmap:CGContextRef = CGBitmapContextCreate(nil,Int(newRect.size.width),Int(newRect.size.height),CGImageGetBitsPerComponent(imageRef),0,CGImageGetColorSpace(imageRef),CGImageGetBitmapInfo(imageRef)
            )
